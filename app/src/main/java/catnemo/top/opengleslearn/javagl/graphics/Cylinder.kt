 ...
 *
 */
class Cylinder(private var radius: Float, private var height: Float, private var numPoints: Int) : Graphics<AttributeColorShaderProgram>() {

    private var colorVb: FloatArray? = null
    override var program: AttributeColorShaderProgram = AttributeColorShaderProgram()
